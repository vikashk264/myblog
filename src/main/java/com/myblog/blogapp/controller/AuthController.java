...
public class AuthController {
    ...
    @Autowired
    private AuthenticationManager authenticationManager; // It's object is not automatically created . If you want to crate an object of AuthenicationManager,
    // go to config file & create a method (line 29-33)
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){
        ...
        // converting role object into set
